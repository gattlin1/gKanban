...
export type CreatePostMutation = { __typename?: 'Mutation', createPost: { __typename?: 'Post', id: number, creatorId: number, text: string, title: string, createdAt: string, updatedAt: string, points: number } };
